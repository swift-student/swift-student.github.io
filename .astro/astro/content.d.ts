...
"2020-9-30-expanding-collection-view-cells/index.md": {
	id: "2020-9-30-expanding-collection-view-cells/index.md";
  slug: "2020-9-30-expanding-collection-view-cells";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"2025-5-7-an-introduction-to-monads-in-swift/index.md": {
	id: "2025-5-7-an-introduction-to-monads-in-swift/index.md";
  slug: "2025-5-7-an-introduction-to-monads-in-swift";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
